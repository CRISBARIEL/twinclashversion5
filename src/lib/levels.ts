...
export const LEVELS: Record<number, LevelConfig> = {
  ...
  142: { world: 29, level: 2, pairs: 10, timeLimit: 100, theme: 'bottles', unlockReward: 140, obstacles: { virus: 2 }, difficulty: 'easy' },
  143: { world: 29, level: 3, pairs: 10, timeLimit: 80, theme: 'bottles', unlockReward: 150, obstacles: { virus: 3, fire: 1 }, difficulty: 'hard' },
  144: { world: 29, level: 4, pairs: 10, timeLimit: 60, theme: 'bottles', unlockReward: 160, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  145: { world: 29, level: 5, pairs: 10, timeLimit: 45, theme: 'bottles', unlockReward: 2900, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  149: { world: 30, level: 4, pairs: 10, timeLimit: 60, theme: 'castle', unlockReward: 170, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  150: { world: 30, level: 5, pairs: 10, timeLimit: 45, theme: 'castle', unlockReward: 3000, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  154: { world: 31, level: 4, pairs: 10, timeLimit: 60, theme: 'forest', unlockReward: 180, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  155: { world: 31, level: 5, pairs: 10, timeLimit: 45, theme: 'forest', unlockReward: 3100, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  159: { world: 32, level: 4, pairs: 10, timeLimit: 60, theme: 'mountains', unlockReward: 190, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  160: { world: 32, level: 5, pairs: 10, timeLimit: 45, theme: 'mountains', unlockReward: 3200, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  164: { world: 33, level: 4, pairs: 10, timeLimit: 60, theme: 'snow', unlockReward: 200, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  165: { world: 33, level: 5, pairs: 10, timeLimit: 45, theme: 'snow', unlockReward: 3300, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  169: { world: 34, level: 4, pairs: 10, timeLimit: 60, theme: 'locations', unlockReward: 210, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  170: { world: 34, level: 5, pairs: 10, timeLimit: 45, theme: 'locations', unlockReward: 3400, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },

  171: { world: 35, level: 1, pairs: 8, timeLimit: 120, theme: 'cups', unlockReward: 190, difficulty: 'very_easy' },
  172: { world: 35, level: 2, pairs: 10, timeLimit: 100, theme: 'cups', unlockReward: 200, obstacles: { virus: 2 }, difficulty: 'easy' },
  173: { world: 35, level: 3, pairs: 10, timeLimit: 80, theme: 'cups', unlockReward: 210, obstacles: { virus: 3, fire: 1 }, difficulty: 'hard' },
  174: { world: 35, level: 4, pairs: 10, timeLimit: 60, theme: 'cups', unlockReward: 220, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  175: { world: 35, level: 5, pairs: 10, timeLimit: 45, theme: 'cups', unlockReward: 3500, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  179: { world: 36, level: 4, pairs: 10, timeLimit: 60, theme: 'energy', unlockReward: 230, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  180: { world: 36, level: 5, pairs: 10, timeLimit: 45, theme: 'energy', unlockReward: 3600, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  184: { world: 37, level: 4, pairs: 10, timeLimit: 60, theme: 'dinosaurs', unlockReward: 240, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  185: { world: 37, level: 5, pairs: 10, timeLimit: 45, theme: 'dinosaurs', unlockReward: 3700, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  189: { world: 38, level: 4, pairs: 10, timeLimit: 60, theme: 'music', unlockReward: 250, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  190: { world: 38, level: 5, pairs: 10, timeLimit: 45, theme: 'music', unlockReward: 3800, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  194: { world: 39, level: 4, pairs: 10, timeLimit: 60, theme: 'summer', unlockReward: 260, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  195: { world: 39, level: 5, pairs: 10, timeLimit: 45, theme: 'summer', unlockReward: 3900, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  199: { world: 40, level: 4, pairs: 10, timeLimit: 60, theme: 'spring', unlockReward: 270, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  200: { world: 40, level: 5, pairs: 10, timeLimit: 45, theme: 'spring', unlockReward: 4000, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  204: { world: 41, level: 4, pairs: 10, timeLimit: 60, theme: 'autumn', unlockReward: 280, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  205: { world: 41, level: 5, pairs: 10, timeLimit: 45, theme: 'autumn', unlockReward: 4100, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  209: { world: 42, level: 4, pairs: 10, timeLimit: 60, theme: 'winter', unlockReward: 290, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  210: { world: 42, level: 5, pairs: 10, timeLimit: 45, theme: 'winter', unlockReward: 4200, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  214: { world: 43, level: 4, pairs: 10, timeLimit: 60, theme: 'cinema', unlockReward: 300, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  215: { world: 43, level: 5, pairs: 10, timeLimit: 45, theme: 'cinema', unlockReward: 4300, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  219: { world: 44, level: 4, pairs: 10, timeLimit: 60, theme: 'history', unlockReward: 310, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  220: { world: 44, level: 5, pairs: 10, timeLimit: 45, theme: 'history', unlockReward: 4400, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  224: { world: 45, level: 4, pairs: 10, timeLimit: 60, theme: 'superheroes', unlockReward: 320, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  225: { world: 45, level: 5, pairs: 10, timeLimit: 45, theme: 'superheroes', unlockReward: 4500, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  229: { world: 46, level: 4, pairs: 10, timeLimit: 60, theme: 'robots', unlockReward: 330, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  230: { world: 46, level: 5, pairs: 10, timeLimit: 45, theme: 'robots', unlockReward: 4600, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },

  231: { world: 47, level: 1, pairs: 8, timeLimit: 120, theme: 'astronauts', unlockReward: 310, difficulty: 'very_easy' },
  232: { world: 47, level: 2, pairs: 10, timeLimit: 100, theme: 'astronauts', unlockReward: 320, obstacles: { virus: 2 }, difficulty: 'easy' },
  233: { world: 47, level: 3, pairs: 10, timeLimit: 80, theme: 'astronauts', unlockReward: 330, obstacles: { virus: 3, fire: 1 }, difficulty: 'hard' },
  234: { world: 47, level: 4, pairs: 10, timeLimit: 60, theme: 'astronauts', unlockReward: 340, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  235: { world: 47, level: 5, pairs: 10, timeLimit: 45, theme: 'astronauts', unlockReward: 4700, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  239: { world: 48, level: 4, pairs: 10, timeLimit: 60, theme: 'castles', unlockReward: 350, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  240: { world: 48, level: 5, pairs: 10, timeLimit: 45, theme: 'castles', unlockReward: 4800, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  244: { world: 49, level: 4, pairs: 10, timeLimit: 60, theme: 'treasures', unlockReward: 360, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  245: { world: 49, level: 5, pairs: 10, timeLimit: 45, theme: 'treasures', unlockReward: 4900, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
  ...
  249: { world: 50, level: 4, pairs: 10, timeLimit: 60, theme: 'volcano', unlockReward: 370, obstacles: { virus: 3, fire: 2 }, difficulty: 'very_hard' },
  250: { world: 50, level: 5, pairs: 10, timeLimit: 45, theme: 'volcano', unlockReward: 5000, obstacles: { virus: 4, fire: 2, bomb: 1 }, difficulty: 'expert' },
};
